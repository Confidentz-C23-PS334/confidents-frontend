package com.confidents.app.modules.dashboard.`data`.viewmodel

import android.os.Bundle
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.confidents.app.modules.dashboard.`data`.model.DashboardModel
...
class DashboardVM : ViewModel(), KoinComponent {
  ...
  val listassortmentofcList: MutableLiveData<MutableList<ListassortmentofcRowModel>> =
