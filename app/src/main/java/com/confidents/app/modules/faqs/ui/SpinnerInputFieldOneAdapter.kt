...
class SpinnerInputFieldOneAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerInputFieldOneModel>
) : ArrayAdapter<SpinnerInputFieldOneModel>(mContext, layoutResource, allItems) {
