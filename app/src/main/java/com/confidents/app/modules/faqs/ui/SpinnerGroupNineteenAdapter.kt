...
class SpinnerGroupNineteenAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupNineteenModel>
) : ArrayAdapter<SpinnerGroupNineteenModel>(mContext, layoutResource, allItems) {
